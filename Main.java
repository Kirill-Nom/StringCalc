...
public class Main {
    public static void main(String[] args) {
        ...
        int number = 0;
            ...
            if (character == '+') {
                ...
                extractedFirst(number, strings);
            } else if (character == '-') {
                extractedSecond(strings);
            } else {
                extractedThird(strings);
            }
    }
    ...
    private static void extractedFirst(int number, String[] strings) {
    ...
    private static void extractedSecond(String[] strings) {
    ...
    private static void extractedThird(String[] strings) {
